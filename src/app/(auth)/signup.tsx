      ...
      >
        ...
        >
          <View className="min-h-screen flex-1 bg-white px-7 pt-7">
            ...
            <Text className="text-center text-[24px] font-bold text-slate-800">
              Create an Account
            </Text>
            ...
            <View className="mt-6">
              ...
              <View className="mb-[13px]">
                ...
                <AuthInput
                  ...
                  placeholder="creativejeff@email.com"
                />
              </View>
              ...
              <View className="mb-[13px]">
                ...
                <AuthInput
                  placeholder="09/05/1987"
                  rightIcon={<Text className="text-lg text-slate-400">▣</Text>}
                />
              </View>
